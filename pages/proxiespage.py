...
class ProxiesPage(QtWidgets.QWidget):
    ...
    def setupUi(self, proxiespage):
        ...
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(int(13*.75))
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18) if platform.system() == "Darwin" else font.setPointSize(int(18*.75))
        font.setWeight(50)
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(22) if platform.system() == "Darwin" else font.setPointSize(int(22*.75))
        font.setWeight(50)
